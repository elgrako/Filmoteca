...
public class FilmDataSource {
    ...
    private static void inializeFilms() {
            ...
            films.add(new Film(R.drawable.backtothefuture, "Back to the future", "Robert Zemeckis", 1985,
            ...
            films.add(new Film(R.drawable.gladiator, "Gladiator", "Ridley Scott", 2000,
            ...
            films.add(new Film(R.drawable.cadenaperpetua, "Cadena Perpetua", "Frank Darabont", 1994,
            ...
            films.add(new Film(R.drawable.elresplandor, "El Resplandor", "Stanley Kubrick", 1980,
            ...
            films.add(new Film(R.drawable.robotsalvaje, "Robot salvaje", "Chris Sanders", 2024,
            ...
            films.add(new Film(R.drawable.pesadillaantesdenavidad, "Pesadilla antes de Navidad", "Tim Burton", 1993,
            ...
            films.add(new Film(R.drawable.cazafantasmas, "Los Cazafantasmas", "Ivan Reitman", 1984,
            ...
            films.add(new Film(R.drawable.delreves2, "Del revés 2", "Kelsey Mann", 2024,
            ...
            films.add(new Film(R.drawable.saturdaynight, "Saturday Night", "Jason Reitman", 2024,
            ...
            films.add(new Film(R.drawable.scream, "Scream: Vigila quién llama", "Wes Craven", 1996,
            ...
            films.add(new Film(R.drawable.deadpoollobezno, "Deadpool y Lobezno", "Shawn Levy", 2024,
            ...
            films.add(new Film(R.drawable.transformersone, "Transformers One", "Josh Cooley", 2024,
            ...
            films.add(new Film(R.drawable.wicked, "Wicked", "Jon M.Chu", 2024,
            ...
            films.add(new Film(R.drawable.maxxxine, "MaXXXine", "Ti West", 2024,
